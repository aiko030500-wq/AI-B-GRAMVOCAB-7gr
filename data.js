...
Irregular: child→children, man→men, person→people`
      ...
      exercises: [
        ...
        { id:"ex4", title:"Reading · True / False (Super Gaming)", type:"choose",
          items:[
    ...
    "m1|3": {
      title: "Module 1 · Lesson 3 — Use of English: Comparatives & Superlatives",
      vocab: [
        { en:"fast", ru:"быстрый" },
      ...
      grammar: {
        ...
        enRule:
`Comparative: compare 2 things (A is taller than B).
Superlative: the best/worst in a group (A is the tallest).`,
        ruRule:
`Сравнительная степень: сравниваем 2 объекта (A taller than B).
Превосходная: самый/самая в группе (the tallest).`,
        formula:
`short adj: adj + -er / the + adj + -est
long adj: more + adj / the most + adj
irregular: good→better→best, bad→worse→worst`
      },
      exercises: [
        { id:"ex1", title:"Matching (adj → RU)", type:"match", pairsCount:6 },
        { id:"ex2", title:"Missing letters", type:"missing",
          items:[
            { q:"b__tt__r", a:"better" },
            { q:"w__rs__", a:"worse" },
            { q:"th__ t__ll__st", a:"the tallest" },
            { q:"m__r__ ex__it__ng", a:"more exciting" },
            { q:"th__ m__st b__r__ng", a:"the most boring" }
          ]
        },
        { id:"ex3", title:"Choose the correct form", type:"choose",
          items:[
            { q:"Football is ____ (popular) than chess in my class.", a:"more popular", opts:["popularer","more popular"] },
            { q:"This game is ____ (easy) than that one.", a:"easier", opts:["easier","more easy"] },
            { q:"Summer is the ____ (hot) season.", a:"hottest", opts:["hotter","hottest"] },
            { q:"English is ____ (good) for my future than many subjects.", a:"better", opts:["better","more good"] },
            { q:"This is the ____ (bad) idea.", a:"worst", opts:["worse","worst"] }
          ]
        },
        { id:"ex4", title:"Build sentences", type:"build",
          items:[
            { words:["My","hobby","is","more","exciting","than","his"], a:"My hobby is more exciting than his." },
            { words:["This","is","the","best","game"], a:"This is the best game." },
            { words:["Skating","is","faster","than","walking"], a:"Skating is faster than walking." }
          ]
        }
      ]
    },
    ...
    "m1|4": {
      ...
      vocab: [
        ...
        { en:"ride a horse", ru:"ездить верхом" },
        { en:"traditional", ru:"традиционный" },
        { en:"equipment", ru:"снаряжение" },
        { en:"helmet", ru:"шлем" },
        { en:"boots", ru:"ботинки" },
        { en:"cost", ru:"стоимость" },
        { en:"class", ru:"занятие/урок" }
      ],
      grammar: {
        title: "Present Simple (speaking about habits)",
        enRule:`Use Present Simple to talk about routines: I ride on Sundays.`,
        ruRule:`Present Simple — для привычек: I ride on Sundays.`,
      ...
      exercises: [
        ...
        { id:"ex2", title:"Missing letters", type:"missing",
          items:[
            ...
            { q:"v__l__ab__e", a:"valuable" }
          ]
        },
        { id:"ex3", title:"Choose the correct answer", type:"choose",
          items:[
            { q:"People ride horses in ____ (city / steppes).", a:"steppes", opts:["city","steppes"] },
            { q:"You should wear a ____ (helmet / scarf).", a:"helmet", opts:["helmet","scarf"] },
            { q:"Horse riding is a ____ sport. (traditional / boring)", a:"traditional", opts:["traditional","boring"] },
            { q:"My classes ____ at 5 pm. (start / are starting)", a:"start", opts:["start","are starting"] }
          ]
        },
        { id:"ex4", title:"Build 3 sentences about you", type:"build",
          items:[
    ...
    "m1|5": {
      ...
      grammar: {
        ...
        enRule:`Use: Let's + V. Ask: What time? Reply: Sure / Sorry, I can't.`,
        ruRule:`Приглашения: Let's + глагол. Вопрос: What time? Ответ: Sure / Sorry, I can't.`,
        formula:`Let's + V1 | Do you want to + V1?`
      },
      exercises: [
        { id:"ex1", title:"Matching (phrase → RU)", type:"match", pairsCount:6 },
        { id:"ex2", title:"Missing letters", type:"missing",
          items:[
        ...
        { id:"ex3", title:"Choose the best reply", type:"choose",
          items:[
            { q:"Let's go to the park.", a:"Sure, why not?", opts:["Sure, why not?","I am playing now."] },
            { q:"Do you want to go skating?", a:"Sorry, I can't.", opts:["Sorry, I can't.","I'm free on Monday."] },
            { q:"See you at 6.", a:"Sounds good!", opts:["Sounds good!","What time?"] }
          ]
        },
        { id:"ex4", title:"Build a dialogue (2 lines)", type:"build",
          items:[
            { words:["A:","Let's","go","to","the","cinema","on","Saturday."], a:"A: Let's go to the cinema on Saturday." },
    ...
    "m1|6": {
      ...
      grammar: {
        title: "Because / so (reason & result)",
      ...
      exercises: [
        ...
        { id:"ex4", title:"Build 3 sentences with because/so", type:"build",
          items:[
    ...
    "m1|7": {
      title: "Module 1 · Lesson 7 — Across the Curriculum (ICT): Blogging",
      vocab: [
        { en:"blog", ru:"блог" },
      ...
      exercises: [
        ...
        { id:"ex4", title:"Build 3 pieces of advice", type:"build",
          items:[
    ...
    "m1|8": {
      title: "Module 1 · Lesson 8 — Writing: An email about a hobby + Quiz",
      vocab: [
