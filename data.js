// data.js — AI Bayan · Excel 7 (Module 1: Lessons 1–1g)
window.APP_DATA = {
  ...
  modules: [
    ...
    // заглушки (можешь потом заменить на контент)
...
Her family supports her, but they remind her to take breaks and not sit too long in front of a screen.`
      ...
      // ✅ Универсальный массив exercises (чтобы app.js мог рисовать одинаково)
      exercises: [
        { id: "ex1", type: "note", title: "Ex 1 — Look at the words", note: "Look at the words and remember their meanings." },

        { id: "ex2", type: "tf", title: "Ex 2 — True / False", items: [
        ...
        { id: "ex3", type: "complete", title: "Ex 3 — Complete the sentences", items: [
        ...
        { id: "ex4", type: "qa", title: "Ex 4 — Answer the questions", items: [
        ...
        { id: "ex5", type: "speaking", title: "Ex 5 — Speaking", prompts: [
          "What hobbies do you like?",
          "Which hobby would you like to take up?",
          "Why do you like it?"
        ]},

        { id: "ex6", type: "mcq", title: "Ex 6 — Choose the correct word", items: [
        ...
        { id: "ex7", type: "mcq", title: "Ex 7 — Choose the correct answer", items: [
        ...
        { id: "ex8", type: "short", title: "Ex 8 — Write short answers", items: [
          { q: "What hobby does Arman like?", a: "paintball" },
          { q: "Where do they play paintball?", a: "in the woods" },
          { q: "Why must players wear protection?", a: "because it is dangerous" }
        ]},

        { id: "ex9", type: "writing", title: "Ex 9 — Writing", note: "Write an email / short text about a hobby (4–6 sentences).",
          writing: {
        ...
        { id: "think", type: "think", title: "THINK!", note: "Which hobby would you like to take up? Why?" }
      ]
    },
...
Irregular: good→better, bad→worse`,
      ...
      exercises: [
        { id: "ex0", type: "note", title: "GRAMMAR", note:
`Present Simple: habits / facts
Present Continuous: now / temporary / arrangements (plans)
...
Irregular: good→better, bad→worse`
        ...
        { id: "ex1", type: "mcq", title: "Ex 1 — Choose the correct form", items: [
        ...
        { id: "ex2", type: "complete", title: "Ex 2 — Write the plural form", items: [
        ...
        { id: "ex3", type: "complete", title: "Ex 3 — Write the comparative form", items: [
        ...
        { id: "ex4", type: "mcq", title: "Ex 4 — Choose the correct sentence", items: [
    ...
    "m1|4": {
      ...
      exercises: [
        { id: "read", type: "reading", title: "Reading", text:
...
Today, horse riding is still popular among young people.` },
        ...
        { id: "ex1", type: "tf", title: "Ex 1 — True / False", items: [
        ...
        { id: "ex2", type: "complete", title: "Ex 2 — Complete", items: [
          { q: "Kazakhstan is famous for ______ riding.", a: "horse" },
          { q: "Horses were used for ______ and hunting.", a: "travelling" }
        ]},

        { id: "ex3", type: "mcq", title: "Ex 3 — Choose the correct answer", items: [
        ...
        { id: "ex5", type: "mcq", title: "Ex 5 — Vocabulary", items: [
          { q: "traditional means …", opts: ["modern", "part of culture"], a: "part of culture" }
        ]},

        { id: "ex6", type: "speaking", title: "Ex 6 — Speaking", prompts: [
          "Is horse riding popular in your country?",
          "Do you like traditional hobbies?"
        ]},

        { id: "ex7", type: "mcq", title: "Ex 7 — Choose the correct sentence", items: [
          { q: "Horse riding is …", opts: ["a traditional hobby", "a new hobby"], a: "a traditional hobby" }
        ]},

        { id: "ex8", type: "writing", title: "Ex 8 — Writing", writing: {
          placeholder: "Write 3–4 sentences about a traditional hobby.",
          plan: ["Name the hobby", "Why people like it", "Is it popular today?"],
          rewardStars: 1
        }}
      ]
    },
...
Some prefer sports, others like creative hobbies.` },
        ...
        { id: "ex1", type: "mcq", title: "Ex 1 — Choose", items: [
        ...
        { id: "ex4", type: "speaking", title: "Ex 4 — Speaking", prompts: [
...
`Bloggers produce videos and posts. They plan, record and edit their content.` },
        ...
        { id: "ex2", type: "mcq", title: "Ex 2 — Choose", items: [
    ...
    "m1|8": {
      ...
      exercises: [
        { id: "model", type: "reading", title: "Model email", text:
`Hi Alex,
...
Aslan` },
        ...
        { id: "ex3", type: "qa", title: "Ex 3 — Answer", items: [
          { q: "What hobby does the writer have?", a: "football" }
        ]},

        { id: "ex4", type: "writing", title: "Ex 4 — Writing", writing: {
          placeholder: "Write your email here...",
          plan: ["Greeting", "Your hobby", "How often", "Why you like it", "Closing"],
          rewardStars: 1
        }}
      ]
    }
